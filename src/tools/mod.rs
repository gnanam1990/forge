...
impl Registry {
    ...
    pub fn builtin() -> Self {
        ...
        registry.register(Box::new(git_ops::GitStashTool::new()));
        registry.register(Box::new(git_ops::GitTagTool::new()));
        registry.register(Box::new(git_ops::GitRemoteTool::new()));
        registry.register(Box::new(git_ops::GitResetTool::new()));
        registry.register(Box::new(git_ops::GitCheckoutTool::new()));
        registry.register(Box::new(git_ops::GitMergeTool::new()));
        registry.register(Box::new(git_ops::GitPushTool::new()));
